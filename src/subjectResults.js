	...
	render() {
		...
		return (
			<div>
				...
				<List {...this.props}>
					<Datagrid {...this.props}>
						<TextField source="name" label="Exams" />
						<NumberField
							source={"subject" + this.state.subject + ".red_band"}
							label="Red Band %"
						/>
						<NumberField
